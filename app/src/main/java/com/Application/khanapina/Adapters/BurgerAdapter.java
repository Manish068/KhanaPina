...
public class BurgerAdapter extends RecyclerView.Adapter<BurgerAdapter.BurgerViewHolder> {
    ...
    public BurgerAdapter(Context context, ArrayList<Menu_item> burger_items, BottomSheetView bottomSheetView) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final BurgerViewHolder holder, int position) {
        ...
        holder.itemPrice.setText(currencyFormatter.format(burger_items.get(position).getItem_price()));
