...
public class FerchAddressIntentService extends IntentService {

    private ResultReceiver resultReceiver;

    public FerchAddressIntentService() {
        ...
        if (intent != null) {
            ...
            if (addresses == null || addresses.isEmpty()) {
                ...
                deliverResultToReceiver(
                        Constants.SUCCESS_RESULT, TextUtils.join(Objects.requireNonNull(System.getProperty("line.separator")), addressFragment)
                );
            }
        }
